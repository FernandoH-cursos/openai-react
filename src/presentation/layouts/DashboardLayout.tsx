...
export const DashboardLayout = () => {
  return (
    <main className="flex flex-row mt-7">
      <nav className="sticky hidden sm:flex flex-col ml-5 w-[370px] min-h-[calc(100vh-3.0rem)] h-[calc(100vh-3.0rem)] bg-white bg-opacity-10 p-5 rounded-3xl overflow-y-scroll scrollbar-width-none">
